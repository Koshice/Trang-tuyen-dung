...
import React, { useEffect, useState } from 'react'; // Sửa ở đây
import PopUpNopBai from './PopUpNopBai';
import { ClockCircleOutlined, ArrowLeftOutlined, ArrowRightOutlined } from '@ant-design/icons'; // Thêm ArrowLeftOutlined và ArrowRightOutlined
import { useAppSelector } from '../redux/hooks';
import { IQuestion } from '../types'; // Import ICollection interface
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            {/* <span>Trang {currentQuestionIndex + 1}</span> */}
